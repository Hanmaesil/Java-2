import javax.swing.JOptionPane; // 작은 창을 띄워준다.
...
public class OkJavaGoInHomeInput3 {
	//args = 매개변수 = paramter, arguments에 적은 값이 들어간다.
	public static void main(String[] args) {
		...
		moodLamp.setBright(Double.parseDouble(bright)); // bright는 dubble형만 들어올수 있어서 변환시켜주는 코드.
		moodLamp.on();
